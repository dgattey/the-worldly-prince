...
Cylinder::Cylinder(const int paramOne, const int paramTwo, const int paramThree, const GLuint vertexLocation, const GLuint normalLocation, NormalRenderer *normRender) :
    Shape(SHAPE_CYLINDER, paramOne, paramTwo, paramThree, vertexLocation, normalLocation, normRender)
{
    m_numCuts = paramOne;
