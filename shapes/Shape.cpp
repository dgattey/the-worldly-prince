...
Shape::Shape(int type, int paramOne, int paramTwo, int paramThree, const GLuint vertexLocation, const GLuint normalLocation, NormalRenderer *normRender){
    m_normRender = normRender;
    m_paramOne = paramOne;
    m_paramTwo = paramTwo;
